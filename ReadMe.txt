========================================================================
    ACTIVE TEMPLATE LIBRARY : ServiceServer Project Overview
========================================================================

AppWizard has created this ServiceServer project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

ServiceServer.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

ServiceServer.vcxproj.filters
...
ServiceServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ServiceServer.h)
        GUID definitions                                (ServiceServer_i.c)
        A type library                                  (ServiceServer.tlb)
        Marshaling code                                 (ServiceServer_p.c and dlldata.c)

ServiceServer.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ServiceServer.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ServiceServer.pch and a precompiled types file named StdAfx.obj.
...
ServiceServerps.vcxproj
	...
	dlldata.c, ServiceServer_i.c and ServiceServer_p.c which are required
	to build the proxy/stub DLL.

ServiceServerps.vcxproj.filters
